  ...
  <section id="container" class="">
      ...
      <section id="main-content">
           <section class="wrapper">
              <!-- Form validations -->              
              <h1 style="font-family:Verdana;">Estate Information</h1>
                <?php 
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                      <?php 
                      $getinfo = $dbConn->query("SELECT * FROM block where block_id = '".$_GET['id']."' ");
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal "  method="post" action="query/executeblockno.php">
                                      <div class="form-group ">
                                          <label for="fullname" class="control-label col-lg-2">Block No <span class="required"></label>
                                         <label for="fullname" class="control-label col-lg-2">  <?php echo $row['block_no'];?> </label>
                                      ...
                                      <div class="form-group ">
                                         ...
                                         <label for="fullname" class="control-label col-lg-2">  <?php echo number_format($row['price'],2);?> </label>
                                          
                                         <label for="fullname" class="control-label col-lg-2"> Downpayment </label>
                                         <label for="fullname" class="control-label col-lg-2">  <?php echo $row['downpayment'];?> </label>
                                      ...
                                      <div class="form-group ">
                                        <label for="fullname" class="control-label col-lg-2">Description <span class="required">*</span></label>
                                         ...
                                         <label for="fullname" class="control-label col-lg-2">  <?php echo $row['description'];?> </label>
