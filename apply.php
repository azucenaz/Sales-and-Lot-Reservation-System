...
<html lang="en">
     ...
     <?php
      ...
      <section id="main-content">
          <section class="wrapper">
              <!-- page start-->
              <h1 style="font-family:Verdana;">Choose Clients</h1>
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
  ...
  <tbody>  
    ...
    <tr class="odd gradeX">
      ...
      <td><a href="pay.php?id=<?php echo $disclients['client_id'];?>&lot=<?php echo $_GET['id'];?>"><button class="btn btn-primary">CHOOSE</button></a> </td>
    </tr>
